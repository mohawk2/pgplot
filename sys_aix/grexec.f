...
C---
    ...
    2 CALL PSDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    3 CALL REDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    4 CALL VPDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    5 CALL X2DRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    6 CALL ZSDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    7 CALL XWDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    8 CALL TKDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
C
      END
