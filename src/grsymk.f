...
C the ASCII codes. Characters >127 are used for special characters
C (greek alphabet, etc.).
C
C Arguments:
C  CODE   (input)  : the ASCII code number (range 0-255).
...
C
      ...
      DATA (HERSH( 92,K),K=1,4) /2235,2235,2235,2235/
...
C Greek alphabet.
C
      DATA (HERSH(128,K),K=1,4) / 527,2027,2027,2027/
      DATA (HERSH(129,K),K=1,4) / 528,2028,2028,2028/
      DATA (HERSH(130,K),K=1,4) / 529,2029,2029,2029/
      DATA (HERSH(131,K),K=1,4) / 530,2030,2030,2030/
      DATA (HERSH(132,K),K=1,4) / 531,2031,2031,2031/
      DATA (HERSH(133,K),K=1,4) / 532,2032,2032,2032/
      DATA (HERSH(134,K),K=1,4) / 533,2033,2033,2033/
      DATA (HERSH(135,K),K=1,4) / 534,2034,2034,2034/
      DATA (HERSH(136,K),K=1,4) / 535,2035,2035,2035/
      DATA (HERSH(137,K),K=1,4) / 536,2036,2036,2036/
      DATA (HERSH(138,K),K=1,4) / 537,2037,2037,2037/
      DATA (HERSH(139,K),K=1,4) / 538,2038,2038,2038/
      DATA (HERSH(140,K),K=1,4) / 539,2039,2039,2039/
      DATA (HERSH(141,K),K=1,4) / 540,2040,2040,2040/
      DATA (HERSH(142,K),K=1,4) / 541,2041,2041,2041/
      DATA (HERSH(143,K),K=1,4) / 542,2042,2042,2042/
      DATA (HERSH(144,K),K=1,4) / 543,2043,2043,2043/
      DATA (HERSH(145,K),K=1,4) / 544,2044,2044,2044/
      DATA (HERSH(146,K),K=1,4) / 545,2045,2045,2045/
      DATA (HERSH(147,K),K=1,4) / 546,2046,2046,2046/
      DATA (HERSH(148,K),K=1,4) / 547,2047,2047,2047/
      DATA (HERSH(149,K),K=1,4) / 548,2048,2048,2048/
      DATA (HERSH(150,K),K=1,4) / 549,2049,2049,2049/
      DATA (HERSH(151,K),K=1,4) / 550,2050,2050,2050/
      DATA (HERSH(152,K),K=1,4) / 627,2127,2127,2127/
      DATA (HERSH(153,K),K=1,4) / 628,2128,2128,2128/
      DATA (HERSH(154,K),K=1,4) / 629,2129,2129,2129/
      DATA (HERSH(155,K),K=1,4) / 630,2130,2130,2130/
      DATA (HERSH(156,K),K=1,4) / 684,2184,2184,2184/
      DATA (HERSH(157,K),K=1,4) / 632,2132,2132,2132/
      DATA (HERSH(158,K),K=1,4) / 633,2133,2133,2133/
      DATA (HERSH(159,K),K=1,4) / 685,2185,2185,2185/
      DATA (HERSH(160,K),K=1,4) / 635,2135,2135,2135/
      DATA (HERSH(161,K),K=1,4) / 636,2136,2136,2136/
      DATA (HERSH(162,K),K=1,4) / 637,2137,2137,2137/
      DATA (HERSH(163,K),K=1,4) / 638,2138,2138,2138/
      DATA (HERSH(164,K),K=1,4) / 639,2139,2139,2139/
      DATA (HERSH(165,K),K=1,4) / 640,2140,2140,2140/
      DATA (HERSH(166,K),K=1,4) / 641,2141,2141,2141/
      DATA (HERSH(167,K),K=1,4) / 642,2142,2142,2142/
      DATA (HERSH(168,K),K=1,4) / 643,2143,2143,2143/
      DATA (HERSH(169,K),K=1,4) / 644,2144,2144,2144/
      DATA (HERSH(170,K),K=1,4) / 645,2145,2145,2145/
      DATA (HERSH(171,K),K=1,4) / 646,2146,2146,2146/
      DATA (HERSH(172,K),K=1,4) / 686,2186,2186,2186/
      DATA (HERSH(173,K),K=1,4) / 648,2148,2148,2148/
      DATA (HERSH(174,K),K=1,4) / 649,2149,2149,2149/
      DATA (HERSH(175,K),K=1,4) / 650,2150,2150,2150/
C
      IF ((CODE.LT.0) .OR. (CODE.GT.175)) THEN
          I = 1
      ELSE
          I = CODE
      END IF
