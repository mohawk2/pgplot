C*GRTE04 -- PGPLOT Tektronix-4010 driver, cursor routine
C+
      SUBROUTINE GRTE04 (IX, IY, IC, IER, UNIT)
...
C
C-----------------------------------------------------------------------
      BYTE BUFFER(7), PROMPT(7)
      DATA PROMPT/29, 4*0, 27, 26/
      INTEGER I1, I2, N
C
