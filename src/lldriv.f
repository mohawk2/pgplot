...
C+
      SUBROUTINE LLDRIV (IFUNC, RBUF, NBUF, CHR, LCHR)
...
C (vertical).
C
C Resolution: 150 (x) x 150 (y) pixels/inch.
C
...
C 431 512-byte blocks before compression.
C
...
C     -- dimensions of plot buffer
      BX = 147 
C             (1176/8, 3 bytes less than 8 full inches)
      BY = 1500
      NPICT = 0
