...
#define KEY_HELP        XK_F5   /* help button */
...
#ifdef PGDISP
{"-geometry",	".lg.geometry",		XrmoptionSepArg, (caddr_t) NULL},
#else
{"-geometry",	".bm.geometry",		XrmoptionSepArg, (caddr_t) NULL},
#endif
{"-bmGeometry",	".bm.geometry",		XrmoptionSepArg, (caddr_t) NULL},
{"-lgGeometry",	".lg.geometry",		XrmoptionSepArg, (caddr_t) NULL},
{"-patchGeometry",".patchgeometry",	XrmoptionSepArg, (caddr_t) NULL},
{"-cmapGeometry",".cmapgeometry",	XrmoptionSepArg, (caddr_t) NULL},
{"-locationGeometry",".locationgeometry",XrmoptionSepArg, (caddr_t) NULL},
{"-histogramGeometry", ".histgeometry",	XrmoptionSepArg, (caddr_t) NULL},
{"-colors",	".bm.maxcolors",	XrmoptionSepArg, (caddr_t) NULL},
{"-maxColors",	".bm.maxcolors",	XrmoptionSepArg, (caddr_t) NULL},
{"-minColors",	".bm.mincolors",	XrmoptionSepArg, (caddr_t) NULL},
{"-privateColors",".bm*private.maxcolors",XrmoptionSepArg, (caddr_t) NULL},
{"-maxPrivateColors",".bm*private.maxcolors",XrmoptionSepArg, (caddr_t) NULL},
{"-minPrivateColors",".bm*private.mincolors",XrmoptionSepArg, (caddr_t) NULL},
{"-lineColors",	".lineColors",		XrmoptionSepArg, (caddr_t) NULL},
{"-help",	".showhelp",		XrmoptionNoArg,  (caddr_t) "True"},
{"-nohelp",	".showhelp",		XrmoptionNoArg,  (caddr_t) "False"},
{"-font",	".font",		XrmoptionSepArg, (caddr_t) NULL},
{"-fn",		".font",		XrmoptionSepArg, (caddr_t) NULL},
{"-psFile",	".psFile",		XrmoptionSepArg, (caddr_t) NULL},
{"-P",		".printer",		XrmoptionSepArg, (caddr_t) NULL},
{"-printer",	".printer",		XrmoptionSepArg, (caddr_t) NULL},
{"-sleepTime",	".sleepTime",		XrmoptionSepArg, (caddr_t) NULL},
{"-forceSquare", ".forceSquare",	XrmoptionNoArg,  (caddr_t) "True"},
{"-noforceSquare", ".forceSquare",	XrmoptionNoArg,  (caddr_t) "False"},
{"-saveColors",	".saveColors",		XrmoptionSepArg, (caddr_t) NULL},
{"-leaveColors",".leaveColors",		XrmoptionSepArg, (caddr_t) NULL},
{"-leftToRight", ".line.leftToRight",	XrmoptionNoArg,  (caddr_t) "True"},
{"-noleftToRight", ".line.leftToRight",	XrmoptionNoArg,  (caddr_t) "False"},
{"-ascendingCoord", ".line.ascending",	XrmoptionNoArg,  (caddr_t) "True"},
{"-noascendingCoord", ".line.ascending", XrmoptionNoArg, (caddr_t) "False"},
{"-plothist",	".line.histogram",	XrmoptionNoArg,  (caddr_t) "True"},
{"-noplothist",	".line.histogram",	XrmoptionNoArg,  (caddr_t) "False"},
{"-ascendingX",	".row.ascending",	XrmoptionNoArg,  (caddr_t) "True"},
{"-noascendingX", ".row.ascending",	XrmoptionNoArg,  (caddr_t) "False"},
{"-rowLeftToRight", ".row.leftToRight",	XrmoptionNoArg,  (caddr_t) "True"},
{"-norowLeftToRight", ".row.leftToRight", XrmoptionNoArg, (caddr_t) "False"},
{"-ascendingY",	".col.ascending",	XrmoptionNoArg,  (caddr_t) "True"},
{"-noascendingY", ".col.ascending",	XrmoptionNoArg,  (caddr_t) "False"},
{"-bottomToTop", ".col.bottomToTop",	XrmoptionNoArg,  (caddr_t) "True"},
{"-nobottomToTop", ".col.bottomToTop",	XrmoptionNoArg,  (caddr_t) "False"},
{"-id",		".id",			XrmoptionSepArg, (caddr_t) NULL},
{"-visual",	".visual",		XrmoptionSepArg, (caddr_t) NULL},
{"-lgCrosshair", ".lg.crosshair",	XrmoptionNoArg,  (caddr_t) "True"},
{"-nolgCrosshair", ".lg.crosshair",	XrmoptionNoArg,  (caddr_t) "False"},
/* The key controls */
{"-zoomin",	".zoomIn",		XrmoptionSepArg, (caddr_t) NULL},
{"-zoomnorm",	".zoomNorm",		XrmoptionSepArg, (caddr_t) NULL},
{"-zoomout",	".zoomOut",		XrmoptionSepArg, (caddr_t) NULL},
{"-zoomxin",	".x.zoomIn",		XrmoptionSepArg, (caddr_t) NULL},
{"-zoomxout",	".x.zoomOut",		XrmoptionSepArg, (caddr_t) NULL},
{"-zoomyin",	".y.zoomIn",		XrmoptionSepArg, (caddr_t) NULL},
{"-zoomyout",	".y.zoomOut",		XrmoptionSepArg, (caddr_t) NULL},
{"-helpkey",	".help",		XrmoptionSepArg, (caddr_t) NULL},
{"-cursor",	".cursor",		XrmoptionSepArg, (caddr_t) NULL},
{"-recenter",	".recenter",		XrmoptionSepArg, (caddr_t) NULL},
{"-showloc",	".showLoc",		XrmoptionSepArg, (caddr_t) NULL},
{"-quit",	".quit",		XrmoptionSepArg, (caddr_t) NULL},
{"-showcmap",	".showCmap",		XrmoptionSepArg, (caddr_t) NULL},
{"-showpatch",	".showPatch",		XrmoptionSepArg, (caddr_t) NULL},
{"-row",	".row",			XrmoptionSepArg, (caddr_t) NULL},
{"-imagePrint",	".imagePs",		XrmoptionSepArg, (caddr_t) NULL},
{"-windowPrint", ".windowPs",		XrmoptionSepArg, (caddr_t) NULL},
{"-invert",	".invertCmap",		XrmoptionSepArg, (caddr_t) NULL},
{"-showsee",	".showSee",		XrmoptionSepArg, (caddr_t) NULL},
{"-column",	".column",		XrmoptionSepArg, (caddr_t) NULL},
{"-decreaseSlit", ".decreaseSlit",	XrmoptionSepArg, (caddr_t) NULL},
{"-increaseSlit", ".increaseSlit",	XrmoptionSepArg, (caddr_t) NULL},
{"-resetSlit",	".resetSlit",		XrmoptionSepArg, (caddr_t) NULL},
{"-inhibit",	".inhibit",		XrmoptionSepArg, (caddr_t) NULL},
{"-histogram",	".histogram",		XrmoptionSepArg, (caddr_t) NULL},
...
{"-title",	".bm*title",		XrmoptionSepArg, (caddr_t) NULL},
{"-bordercolor", "*borderColor",	XrmoptionSepArg, (caddr_t) NULL},
{"-bc",		"*borderColor",		XrmoptionSepArg, (caddr_t) NULL},
{"-icon",	"*icon",		XrmoptionSepArg, (caddr_t) NULL},
{"-iconGeometry", ".bm*iconGeometry",	XrmoptionSepArg, (caddr_t) NULL},
{"-iconic",	".bm*iconic",		XrmoptionNoArg,  (caddr_t) "on"},
...
{"-minGeometry",".bm*minGeometry",	XrmoptionSepArg, (caddr_t) NULL},
{"-maxGeometry",".bm*maxGeometry",	XrmoptionSepArg, (caddr_t) NULL},
/* for line graphics only */
{"-blank",	".lg*blank",		XrmoptionSepArg, (caddr_t) NULL},
...
"\t[-histogramGeometry WxH] [-plothist] [-noplothist]\n",
"",
};
void Usage(prog)
char *prog;
