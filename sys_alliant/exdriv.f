...
C+
      SUBROUTINE    EXDRIV (IFUNC, RBUF, NBUF, CHR, LCHR)
...
C--
      ...
      PARAMETER    (DEVTYP = 'EXCL')
      PARAMETER    (EXSIZE = 10250.0)
      PARAMETER    (EYSIZE =  7750.0)
      PARAMETER    (PGO = 1)
      PARAMETER    (XOFF = (11000 - EXSIZE) / 2)
      PARAMETER    (YOFF =  (8500 - EYSIZE) / 2)
C
C     PARAMETER    (DEFNAM = 'PGPLOT.VXPLOT')
C     PARAMETER    (DEVTYP = 'VEXCL')
C     PARAMETER    (EXSIZE =  7750.0)
C     PARAMETER    (EYSIZE = 10250.0)
C     PARAMETER    (PGO = 0)
C     PARAMETER    (XOFF =  (8500 - EXSIZE) / 2)
C     PARAMETER    (YOFF = (11000 - EYSIZE) / 2)
C--
...
C
 ...
 2000 FORMAT (A2, ';', I5.5, ';', I4.4, A2) ! (landscape)
C2000 FORMAT (A2, ';', I4.4, ';', I5.5, A2) ! (portrait)
...
C
 ...
 3000    FORMAT (I5.5, ':', I4.4, ';') ! (landscape)
C3000    FORMAT (I4.4, ':', I5.5, ';') ! (portrait)
