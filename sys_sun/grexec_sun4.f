...
C---
    ...
    4 CALL REDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    5 CALL SVDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    6 CALL TEDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    7 CALL VPDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    8 CALL VTDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
    9 CALL XWDRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
   10 CALL X2DRIV(IFUNC,RBUF,NBUF,CHR,LCHR)
      RETURN
C
      END
