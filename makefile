...
SRC=/usr/local/pgplot
SRCDIR=/usr/local/pgplot/src
DEMDIR=/usr/local/pgplot/examples
FNTDIR=/usr/local/pgplot/fonts
DRVDIR=/usr/local/pgplot/drivers
SYSDIR=/usr/local/pgplot/sys_bsd
PGDDIR=/usr/local/pgplot/pgdispd
GENDIR=/usr/local/pgplot/sys
XMDIR=/usr/local/pgplot/drivers/xmotif
TKDIR=/usr/local/pgplot/drivers/xtk
PTKDIR=/usr/local/pgplot/drivers/ptk
#
...
MOTIF_LIBS=-lXm -lXt -L/usr/X11R6/lib -lX11 -lm 
TK_LIBS=-L/usr/local/lib -ltk -ltcl -L/usr/X11R6/lib -lX11 -lm -ldl
PTK_LIBS=
#
...
GR_ROUTINES= grarea.o grbpic.o grchsz.o grclip.o grclos.o grclpl.o grctoi.o grcurs.o grdot0.o grdot1.o grdtyp.o gresc.o  grepic.o gretxt.o grfa.o   grfao.o  grgfil.o grgray.o grimg0.o grimg1.o grimg2.o grimg3.o grrgb0.o grrgb1.o grrgb2.o grsvd.o grinit.o gritoc.o grlen.o  grlin0.o grlin1.o grlin2.o grlin3.o grlina.o grmcur.o grmker.o grmova.o grmsg.o gropen.o grpage.o grpars.o grpixl.o grpocl.o grprom.o grpxpo.o grpxps.o grpxpx.o grpxre.o grqcap.o grqci.o  grqcol.o grqcr.o  grqdev.o grqdt.o  grqfnt.o grqls.o  grqlw.o  grqpos.o grqtxt.o grqtyp.o grquit.o grrec0.o grrect.o grsci.o  grscr.o  grscrl.o grsetc.o grsets.o grsfnt.o grsize.o grskpb.o grslct.o grsls.o  grslw.o  grsyds.o grsymk.o grsyxd.o grterm.o grtext.o grtoup.o grtrim.o grtrn0.o grtxy0.o grvct0.o grwarn.o grxhls.o grxrgb.o
...
DRIVERS=gidriv.o nudriv.o ppdriv.o psdriv.o ttdriv.o xwdriv.o 
...
pgrgbi.o: $(SRCDIR)/pgrgbi.f
	$(FCOMPL) -c $(FFLAGC) $(SRCDIR)/pgrgbi.f
...
grrgb0.o: $(SRCDIR)/grrgb0.f
	$(FCOMPL) -c $(FFLAGC) $(SRCDIR)/grrgb0.f
grrgb1.o: $(SRCDIR)/grrgb1.f
	$(FCOMPL) -c $(FFLAGC) $(SRCDIR)/grrgb1.f
grrgb2.o: $(SRCDIR)/grrgb2.f
	$(FCOMPL) -c $(FFLAGC) $(SRCDIR)/grrgb2.f
grsvd.o: $(SRCDIR)/grsvd.f
	$(FCOMPL) -c $(FFLAGC) $(SRCDIR)/grsvd.f
...
ppdriv.o: $(DRVDIR)/ppdriv.f
	$(FCOMPL) -c $(FFLAGC) $(DRVDIR)/ppdriv.f
...
pgbind: $(SRC)/cpg/pgbind.c
	$(CCOMPL) $(CFLAGC) $(CFLAG_PGBIND) $(SRC)/cpg/pgbind.c -o pgbind
